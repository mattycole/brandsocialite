    ...
    if (width > 768) {
          ...
          <nav class='menu'>
            ...
            <div class='menu__right'>
              <ul class='menu__list'>
                ...
                <li class='menu__list-item'>
                  <a class='menu__link' href='#/talent'>
                    Talent
                  </a>
                </li>
                <li class='menu__list-item'>
      ...
      this.state.renderComponent = (
        <Menu>
          ...
          <a href='#' className='links noSelect'>
            <FontAwesomeIcon icon={faHome} />
            <span> Home</span>
          </a>
          <a href='#/talent' className='links noSelect'>
            <FontAwesomeIcon icon={faRing} />
            <span> Talent</span>
          </a>
          <a href='#/brands' className='links noSelect'>
          ...
          <footer>
            ...
            <a
              href='https://www.instagram.com/brandsocialite'
              target='_blank'
              rel='noopener noreferrer'>
              <FontAwesomeIcon
                icon={faInstagram}
            ...
            <a
              href='https://www.linkedin.com/company/brandsocialite'
              target='_blank'
              rel='noopener noreferrer'>
              <FontAwesomeIcon
                icon={faLinkedin}
